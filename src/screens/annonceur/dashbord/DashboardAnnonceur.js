...
export default function DashboardAnnonceur({ navigation }) {
    const stats = [
    ...
    const commissions = [
        { title: "Ventes track", soustitre: 'En attente de validation', amount: 700 },
        { title: "Leads track", soustitre: 'En attente de validation', amount: 250 },
        { title: "Commission", soustitre: 'En attente de facturation', amount: 1000 },
    ];
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.commissionsTitle}>Tracking & Commissions</Text>
            ...
            <Card style={styles.programsContainer}>
                <View style={styles.row}>
                    <Text style={styles.programsTitle}>Votre Programmes</Text>
                    <Pressable
                        style={styles.button}
            ...
            <View style={styles.row}>
                <View style={styles.boxpay}>
                    <View style={styles.row}>
                        <Text style={styles.paymentsTitle}>Dernieres factures</Text>
                        <Pressable
                            style={styles.button}
                            onPress={() => navigation.navigate("PROGRAMMES")}
                        >
